...
public class Pineapple_Esq : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.position = new Vector3(-8, pineapple[indiceUpdatePosY], 0);  //posição inicial do abacaxi ao spawnar
    ...
    private void OnTriggerEnter2D(Collider2D player)
    {
        ...
        {
            auxPos_Y *= -1;
            transform.position = new Vector3(-8, pineapple[indiceUpdatePosY + 1], 0);
            indiceUpdatePosY += 1;
        ...
        {            
            ...
            else if (auxPos_Y == 1 && indiceUpdatePosY == 4)        //Checa se vai subir para 4º posição ou não
            {
                ...
                if (z == 1)      //só vai até a terceira
                {
                    indiceUpdatePosY = 3;
                    auxPos_Y = auxPos_Y * -1;
                    transform.position = new Vector3(-8, pineapple[indiceUpdatePosY], 0);
                    tempo = (gameManager.tempoRelativo / 60) + tempoAux;
                }
